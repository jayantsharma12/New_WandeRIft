            ...
            <Card className="border-0 shadow-lg">
              ...
              <CardContent className="space-y-8 p-8">
                {generatedData?.itinerary.map((day, index) => (
                  <div key={index} className="border-l-4 border-orange-500 pl-8 pb-8 last:pb-0">
                    <div className="flex items-center space-x-3 mb-4">
                      <div className="bg-orange-500 text-white rounded-full w-10 h-10 flex items-center justify-center text-sm font-bold">
                        {day.day}
                      </div>
                      <div>
